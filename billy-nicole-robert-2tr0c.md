...
Pronunciation |
Nickname/Alias | 
Meaning | AN English name, usually short for William | The name "Māyā" is a feminine given name, in Hindu mythology the name is from the goddess Durga, the name also means "illusion"  | "Robert" is a German given name, someone who is bright, well-known and lively. | --- |
Origin |
Title |
Pet Name |
ID Number |
